...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Pie_t, stringdata0) + ofs \
...
const QMetaObject Pie::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Pie.data,
...
void *Pie::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Pie.stringdata0))
        return static_cast<void*>(const_cast< Pie*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< Pie*>(this));
