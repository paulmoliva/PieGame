...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StartButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StartButton_t qt_meta_stringdata_StartButton = {
    {
QT_MOC_LITERAL(0, 0, 11), // "StartButton"
QT_MOC_LITERAL(1, 12, 7), // "clicked"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "StartButton\0clicked\0"
};
...
void StartButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        StartButton *_t = static_cast<StartButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (StartButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StartButton::clicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject StartButton::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_StartButton.data,
      qt_meta_data_StartButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StartButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StartButton.stringdata0))
        return static_cast<void*>(const_cast< StartButton*>(this));
    if (!strcmp(_clname, "QGraphicsRectItem"))
        return static_cast< QGraphicsRectItem*>(const_cast< StartButton*>(this));
